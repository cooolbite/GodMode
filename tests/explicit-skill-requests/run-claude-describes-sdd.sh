...
mkdir -p "$PROJECT_DIR/docs/godmode/plans"
...
# Create a plan
cat > "$PROJECT_DIR/docs/godmode/plans/auth-system.md" << 'EOF'
...
claude -p "I have a plan at docs/godmode/plans/auth-system.md. Tell me about my options for executing it, including what subagent-driven-development means and how it works." \
    --model haiku \
