...
mkdir -p src test docs/godmode/plans

# Create a simple implementation plan
cat > docs/godmode/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/godmode/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/godmode/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"godmode:subagent-driven-development"' "$SESSION_FILE"; then
