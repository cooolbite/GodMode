...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/godmode-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using godmode:subagent-driven-development. The plan is at: $PLAN_PATH"
