...
<!-- GodMode core contains general-purpose skills and infrastructure
...
<!-- If this PR adds support for a new harness (IDE, CLI tool, agent
     ...
     A real integration loads the `godmode-core` bootstrap at session
...
- [ ] If this is a skills change: I used `GodMode:writing-skills` and
