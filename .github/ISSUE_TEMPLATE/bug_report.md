...
## Is this a GodMode issue or a platform issue?
<!-- GodMode is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without GodMode installed.

     If the problem persists without GodMode, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without GodMode installed
