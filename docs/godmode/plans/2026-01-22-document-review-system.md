...
> **For agentic workers:** REQUIRED: Use godmode:subagent-driven-development (if subagents available) or godmode:executing-plans to implement this plan.
...
**Spec:** docs/GodMode/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/GodMode/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use godmode:subagent-driven-development (if subagents available) or godmode:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
